    ...
    methods
        ...
        function [obj, curr_avg_offset_us, curr_acc_offset_us] = estimate_offset(obj, a)
            ...
            elseif strcmp(obj.mode, 'ntp-based')
                ...
                % Your code goes here.
                curr_avg_offset_us = (obj.T_sec - ((a(obj.N) - a0)/obj.N)) * 10^6;
        ...
        function [obj, curr_error] = update_clock_skew(obj, curr_avg_offset_us, curr_acc_offset_us)
           ...
           % Your code goes here.
           lambda = 0.9995;
           num = (lambda ^ -1) * prev_P * time_elapsed_sec;
           den = 1 + (lambda^-1)*(time_elapsed_sec^2)*prev_P;
           gainG = num/den;
                     
           curr_skew = prev_skew + gainG * curr_error;
           curr_P = (lambda^-1)* (prev_P - gainG * time_elapsed_sec * prev_P);
